...
namespace botw_editor
{
  public class FrmMain : Form
  {
    ...
    {
      this.txtLog.AppendText("[" + DateTime.Now.ToString("HH:mm:ss", (IFormatProvider) CultureInfo.InvariantCulture) + "] " + text + Environment.NewLine);
    }
    ...
    private void btnSettingsSave_Click(object sender, EventArgs e)
    {
      ...
      {
        int num1 = (int) MessageBox.Show("An error occured.");
      }
    }
    ...
    private void btnSettingsClear_Click(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index < currentSettings.action_datas.Count; ++index)
        currentSettings.action_datas[index] = new actiondata()
        {
          section = currentSettings.action_datas[index].section
        };
    ...
    private void btnSettingsExport_Click(object sender, EventArgs e)
    {
      ...
      {
        int num1 = (int) MessageBox.Show("Settings exported.");
      }
      else
      {
        int num2 = (int) MessageBox.Show("Error exporting settings.");
      }
    }
    ...
    private void btnSettingsImport_Click(object sender, EventArgs e)
    {
      ...
      if (openFileDialog.ShowDialog() != DialogResult.OK || !(openFileDialog.FileName != "") || !File.Exists(openFileDialog.FileName))
        return;
      this.myApp.applySettings(this.myApp.readSettings(openFileDialog.FileName));
    ...
    private void numInternalLoopMs_ValueChanged(object sender, EventArgs e)
    {
      ...
      this.Putlog("Internal Loop timings set to : " + (object) this.myApp.nbInternalLoopMs + " ms");
    }
    ...
    private void numSpacingMs_ValueChanged(object sender, EventArgs e)
    {
      ...
      this.Putlog("Spacing timings set to : " + (object) this.myApp.nbSpacingMs + " ms");
    }
    ...
    private void button3_Click(object sender, EventArgs e)
    {
      if (this.myApp == null)
        return;
      this.myApp.generateCompareReport("memory_changes_" + DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss", (IFormatProvider) CultureInfo.InvariantCulture) + ".txt");
    }

    private void btnFindMemoryRegionByAddress_Click(object sender, EventArgs e)
    {
      long int64 = MemAPI.HexStringToInt64(this.txtFindMemoryRegionByAddress.Text);
      if (this.myApp == null)
        return;
      this.myApp.searchMemoryRegionForAddress(int64);
    }

    private void btntxtFindMemoryRegionBySize_Click(object sender, EventArgs e)
    {
      long int64_1 = MemAPI.HexStringToInt64(this.txtFindMemoryRegionBySize.Text);
      long int64_2 = MemAPI.HexStringToInt64(this.txtFindMemoryRegionByAddress.Text);
      if (this.myApp == null)
        return;
      this.myApp.searchMemoryRegionForSize(int64_1, int64_2);
    }
    ...
    {
      if (this.myApp == null || this.trackTime.Tag != null)
        return;
      this.myApp.setTime(this.trackTime.Value);
    }

    private void btnCompareAddress_Click(object sender, EventArgs e)
    {
      long int64 = MemAPI.HexStringToInt64(this.txtCompareAddress.Text);
      if (this.myApp == null)
        return;
      this.myApp.showCompareAddress(int64);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.numSpacingMs.BeginInit();
      this.numInternalLoopMs.BeginInit();
      this.groupBox2.SuspendLayout();
      this.groupBox1.SuspendLayout();
      this.groupBox12.SuspendLayout();
      this.groupBox11.SuspendLayout();
      this.tabPage22.SuspendLayout();
      this.trackTime.BeginInit();
      this.SuspendLayout();
      this.tabMain.Controls.Add((Control) this.tabPage9);
      this.tabMain.Location = new Point(502, 310);
      this.tabMain.Name = "tabMain";
      this.tabMain.SelectedIndex = 0;
      this.tabMain.Size = new Size(507, 173);
      this.tabMain.TabIndex = 4;
      this.tabPage9.Controls.Add((Control) this.txtLog);
      ...
      this.tabItems.Controls.Add((Control) this.tabPage1);
      this.tabItems.Controls.Add((Control) this.tabPage2);
      this.tabItems.Controls.Add((Control) this.tabPage3);
      this.tabItems.Controls.Add((Control) this.tabPage4);
      this.tabItems.Controls.Add((Control) this.tabPage5);
      this.tabItems.Controls.Add((Control) this.tabPage6);
      this.tabItems.Controls.Add((Control) this.tabPage7);
      this.tabItems.Controls.Add((Control) this.tabPage8);
      this.tabItems.Controls.Add((Control) this.tabPage12);
      this.tabItems.Controls.Add((Control) this.tabPage20);
      ...
      this.tabPage1.Controls.Add((Control) this.btnInventoryItemUnlock);
      this.tabPage1.Controls.Add((Control) this.gbInventoryEdit);
      this.tabPage1.Controls.Add((Control) this.lstInventory);
      ...
      this.gbInventoryEdit.Controls.Add((Control) this.cbInventoryItemBonusType);
      this.gbInventoryEdit.Controls.Add((Control) this.btnInventoryItemUpdate);
      this.gbInventoryEdit.Controls.Add((Control) this.label4);
      this.gbInventoryEdit.Controls.Add((Control) this.txtInventoryItemBonusValue);
      this.gbInventoryEdit.Controls.Add((Control) this.label5);
      this.gbInventoryEdit.Controls.Add((Control) this.txtInventoryItemBonusType);
      this.gbInventoryEdit.Controls.Add((Control) this.label3);
      this.gbInventoryEdit.Controls.Add((Control) this.cbInventoryItemName);
      this.gbInventoryEdit.Controls.Add((Control) this.label2);
      this.gbInventoryEdit.Controls.Add((Control) this.txtInventoryItemQtDur);
      this.gbInventoryEdit.Controls.Add((Control) this.label1);
      this.gbInventoryEdit.Controls.Add((Control) this.txtInventoryItemID);
      ...
      this.label4.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage2.Controls.Add((Control) this.btnWeaponsItemUnlock);
      this.tabPage2.Controls.Add((Control) this.gbWeaponsEdit);
      this.tabPage2.Controls.Add((Control) this.lstWeapons);
      ...
      this.gbWeaponsEdit.Controls.Add((Control) this.cbWeaponsItemBonusType);
      this.gbWeaponsEdit.Controls.Add((Control) this.btnWeaponsItemUpdate);
      this.gbWeaponsEdit.Controls.Add((Control) this.label6);
      this.gbWeaponsEdit.Controls.Add((Control) this.txtWeaponsItemBonusValue);
      this.gbWeaponsEdit.Controls.Add((Control) this.label7);
      this.gbWeaponsEdit.Controls.Add((Control) this.txtWeaponsItemBonusType);
      this.gbWeaponsEdit.Controls.Add((Control) this.label8);
      this.gbWeaponsEdit.Controls.Add((Control) this.cbWeaponsItemName);
      this.gbWeaponsEdit.Controls.Add((Control) this.label9);
      this.gbWeaponsEdit.Controls.Add((Control) this.txtWeaponsItemQtDur);
      this.gbWeaponsEdit.Controls.Add((Control) this.label10);
      this.gbWeaponsEdit.Controls.Add((Control) this.txtWeaponsItemID);
      ...
      this.label6.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage3.Controls.Add((Control) this.btnArcheryItemUnlock);
      this.tabPage3.Controls.Add((Control) this.gbArcheryEdit);
      this.tabPage3.Controls.Add((Control) this.lstArchery);
      ...
      this.gbArcheryEdit.Controls.Add((Control) this.cbArcheryItemBonusType);
      this.gbArcheryEdit.Controls.Add((Control) this.btnArcheryItemUpdate);
      this.gbArcheryEdit.Controls.Add((Control) this.label11);
      this.gbArcheryEdit.Controls.Add((Control) this.txtArcheryItemBonusValue);
      this.gbArcheryEdit.Controls.Add((Control) this.label12);
      this.gbArcheryEdit.Controls.Add((Control) this.txtArcheryItemBonusType);
      this.gbArcheryEdit.Controls.Add((Control) this.label13);
      this.gbArcheryEdit.Controls.Add((Control) this.cbArcheryItemName);
      this.gbArcheryEdit.Controls.Add((Control) this.label14);
      this.gbArcheryEdit.Controls.Add((Control) this.txtArcheryItemQtDur);
      this.gbArcheryEdit.Controls.Add((Control) this.label15);
      this.gbArcheryEdit.Controls.Add((Control) this.txtArcheryItemID);
      ...
      this.label11.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage4.Controls.Add((Control) this.btnShieldsItemUnlock);
      this.tabPage4.Controls.Add((Control) this.gbShieldsEdit);
      this.tabPage4.Controls.Add((Control) this.lstShields);
      ...
      this.gbShieldsEdit.Controls.Add((Control) this.cbShieldsItemBonusType);
      this.gbShieldsEdit.Controls.Add((Control) this.btnShieldsItemUpdate);
      this.gbShieldsEdit.Controls.Add((Control) this.label16);
      this.gbShieldsEdit.Controls.Add((Control) this.txtShieldsItemBonusValue);
      this.gbShieldsEdit.Controls.Add((Control) this.label17);
      this.gbShieldsEdit.Controls.Add((Control) this.txtShieldsItemBonusType);
      this.gbShieldsEdit.Controls.Add((Control) this.label18);
      this.gbShieldsEdit.Controls.Add((Control) this.cbShieldsItemName);
      this.gbShieldsEdit.Controls.Add((Control) this.label19);
      this.gbShieldsEdit.Controls.Add((Control) this.txtShieldsItemQtDur);
      this.gbShieldsEdit.Controls.Add((Control) this.label20);
      this.gbShieldsEdit.Controls.Add((Control) this.txtShieldsItemID);
      ...
      this.label16.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage5.Controls.Add((Control) this.btnArmorsItemUnlock);
      this.tabPage5.Controls.Add((Control) this.gbArmorsEdit);
      this.tabPage5.Controls.Add((Control) this.lstArmors);
      ...
      this.gbArmorsEdit.Controls.Add((Control) this.cbArmorsItemBonusType);
      this.gbArmorsEdit.Controls.Add((Control) this.btnArmorsItemUpdate);
      this.gbArmorsEdit.Controls.Add((Control) this.label21);
      this.gbArmorsEdit.Controls.Add((Control) this.txtArmorsItemBonusValue);
      this.gbArmorsEdit.Controls.Add((Control) this.label22);
      this.gbArmorsEdit.Controls.Add((Control) this.txtArmorsItemBonusType);
      this.gbArmorsEdit.Controls.Add((Control) this.label23);
      this.gbArmorsEdit.Controls.Add((Control) this.cbArmorsItemName);
      this.gbArmorsEdit.Controls.Add((Control) this.label24);
      this.gbArmorsEdit.Controls.Add((Control) this.txtArmorsItemQtDur);
      this.gbArmorsEdit.Controls.Add((Control) this.label25);
      this.gbArmorsEdit.Controls.Add((Control) this.txtArmorsItemID);
      ...
      this.label21.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage6.Controls.Add((Control) this.btnMaterialsItemUnlock);
      this.tabPage6.Controls.Add((Control) this.gbMaterialsEdit);
      this.tabPage6.Controls.Add((Control) this.lstMaterials);
      ...
      this.gbMaterialsEdit.Controls.Add((Control) this.cbMaterialsItemBonusType);
      this.gbMaterialsEdit.Controls.Add((Control) this.btnMaterialsItemUpdate);
      this.gbMaterialsEdit.Controls.Add((Control) this.label26);
      this.gbMaterialsEdit.Controls.Add((Control) this.txtMaterialsItemBonusValue);
      this.gbMaterialsEdit.Controls.Add((Control) this.label27);
      this.gbMaterialsEdit.Controls.Add((Control) this.txtMaterialsItemBonusType);
      this.gbMaterialsEdit.Controls.Add((Control) this.label28);
      this.gbMaterialsEdit.Controls.Add((Control) this.cbMaterialsItemName);
      this.gbMaterialsEdit.Controls.Add((Control) this.label29);
      this.gbMaterialsEdit.Controls.Add((Control) this.txtMaterialsItemQtDur);
      this.gbMaterialsEdit.Controls.Add((Control) this.label30);
      this.gbMaterialsEdit.Controls.Add((Control) this.txtMaterialsItemID);
      ...
      this.label26.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage7.Controls.Add((Control) this.btnFoodItemUnlock);
      this.tabPage7.Controls.Add((Control) this.gbFoodEdit);
      this.tabPage7.Controls.Add((Control) this.lstFood);
      ...
      this.gbFoodEdit.Controls.Add((Control) this.cbFoodItemBonusType);
      this.gbFoodEdit.Controls.Add((Control) this.btnFoodItemUpdate);
      this.gbFoodEdit.Controls.Add((Control) this.label31);
      this.gbFoodEdit.Controls.Add((Control) this.txtFoodItemBonusValue);
      this.gbFoodEdit.Controls.Add((Control) this.label32);
      this.gbFoodEdit.Controls.Add((Control) this.txtFoodItemBonusType);
      this.gbFoodEdit.Controls.Add((Control) this.label33);
      this.gbFoodEdit.Controls.Add((Control) this.cbFoodItemName);
      this.gbFoodEdit.Controls.Add((Control) this.label34);
      this.gbFoodEdit.Controls.Add((Control) this.txtFoodItemQtDur);
      this.gbFoodEdit.Controls.Add((Control) this.label35);
      this.gbFoodEdit.Controls.Add((Control) this.txtFoodItemID);
      ...
      this.label31.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage8.Controls.Add((Control) this.btnOtherItemUnlock);
      this.tabPage8.Controls.Add((Control) this.gbOtherEdit);
      this.tabPage8.Controls.Add((Control) this.lstOther);
      ...
      this.gbOtherEdit.Controls.Add((Control) this.cbOtherItemBonusType);
      this.gbOtherEdit.Controls.Add((Control) this.btnOtherItemUpdate);
      this.gbOtherEdit.Controls.Add((Control) this.label36);
      this.gbOtherEdit.Controls.Add((Control) this.txtOtherItemBonusValue);
      this.gbOtherEdit.Controls.Add((Control) this.label37);
      this.gbOtherEdit.Controls.Add((Control) this.txtOtherItemBonusType);
      this.gbOtherEdit.Controls.Add((Control) this.label38);
      this.gbOtherEdit.Controls.Add((Control) this.cbOtherItemName);
      this.gbOtherEdit.Controls.Add((Control) this.label39);
      this.gbOtherEdit.Controls.Add((Control) this.txtOtherItemQtDur);
      this.gbOtherEdit.Controls.Add((Control) this.label40);
      this.gbOtherEdit.Controls.Add((Control) this.txtOtherItemID);
      ...
      this.label36.Location = new Point(4, (int) sbyte.MaxValue);
      ...
      this.tabPage12.Controls.Add((Control) this.gbRupees);
      ...
      this.gbRupees.Controls.Add((Control) this.btnRefreshRupees);
      this.gbRupees.Controls.Add((Control) this.btnUpdateRupees);
      this.gbRupees.Controls.Add((Control) this.label71);
      this.gbRupees.Controls.Add((Control) this.txtRupees);
      ...
      this.tabPage20.Controls.Add((Control) this.gbShieldsSlots);
      this.tabPage20.Controls.Add((Control) this.gbBowsSlots);
      this.tabPage20.Controls.Add((Control) this.gbWeaponsSlots);
      ...
      this.gbShieldsSlots.Controls.Add((Control) this.btnRefreshShieldsSlots);
      this.gbShieldsSlots.Controls.Add((Control) this.btnUpdateShieldsSlots);
      this.gbShieldsSlots.Controls.Add((Control) this.label52);
      this.gbShieldsSlots.Controls.Add((Control) this.txtShieldsSlots);
      ...
      this.gbBowsSlots.Controls.Add((Control) this.btnRefreshBowsSlots);
      this.gbBowsSlots.Controls.Add((Control) this.btnUpdateBowsSlots);
      this.gbBowsSlots.Controls.Add((Control) this.label51);
      this.gbBowsSlots.Controls.Add((Control) this.txtBowsSlots);
      ...
      this.gbWeaponsSlots.Controls.Add((Control) this.btnRefreshWeaponsSlots);
      this.gbWeaponsSlots.Controls.Add((Control) this.btnUpdateWeaponsSlots);
      this.gbWeaponsSlots.Controls.Add((Control) this.label50);
      this.gbWeaponsSlots.Controls.Add((Control) this.txtWeaponsSlots);
      ...
      this.tabActions.Controls.Add((Control) this.tabPage11);
      this.tabActions.Controls.Add((Control) this.tabPage14);
      this.tabActions.Controls.Add((Control) this.tabPage15);
      this.tabActions.Controls.Add((Control) this.tabPage16);
      this.tabActions.Controls.Add((Control) this.tabPage17);
      this.tabActions.Controls.Add((Control) this.tabPage21);
      this.tabActions.Controls.Add((Control) this.tabPage18);
      this.tabActions.Controls.Add((Control) this.tabPage19);
      this.tabActions.Controls.Add((Control) this.tabPage13);
      ...
      this.tabPage11.Controls.Add((Control) this.groupBox13);
      this.tabPage11.Controls.Add((Control) this.groupBox10);
      ...
      this.groupBox13.Controls.Add((Control) this.lstWeaponsFilter);
      this.groupBox13.Controls.Add((Control) this.optionWeaponsFilterList);
      this.groupBox13.Controls.Add((Control) this.optionWeaponsNoFilter);
      ...
      this.groupBox10.Controls.Add((Control) this.chkWeaponsUseHotkey);
      this.groupBox10.Controls.Add((Control) this.txtWeaponsHotKey);
      this.groupBox10.Controls.Add((Control) this.chkWeaponsDisableWhenDone);
      this.groupBox10.Controls.Add((Control) this.chkWeaponsActiveInactive);
      this.groupBox10.Controls.Add((Control) this.txtWeaponsMax);
      this.groupBox10.Controls.Add((Control) this.label44);
      this.groupBox10.Controls.Add((Control) this.txtWeaponsQuantity);
      this.groupBox10.Controls.Add((Control) this.label46);
      this.groupBox10.Controls.Add((Control) this.txtWeaponsTimer);
      this.groupBox10.Controls.Add((Control) this.label47);
      this.groupBox10.Controls.Add((Control) this.txtWeaponsFixed);
      this.groupBox10.Controls.Add((Control) this.optionWeaponsTimer);
      this.groupBox10.Controls.Add((Control) this.optionWeaponsFixed);
      ...
      this.tabPage14.Controls.Add((Control) this.groupBox17);
      this.tabPage14.Controls.Add((Control) this.groupBox18);
      ...
      this.groupBox17.Controls.Add((Control) this.lstBowsFilter);
      this.groupBox17.Controls.Add((Control) this.optionBowsFilterList);
      this.groupBox17.Controls.Add((Control) this.optionBowsNoFilter);
      ...
      this.groupBox18.Controls.Add((Control) this.chkBowsUseHotkey);
      this.groupBox18.Controls.Add((Control) this.txtBowsHotKey);
      this.groupBox18.Controls.Add((Control) this.chkBowsDisableWhenDone);
      this.groupBox18.Controls.Add((Control) this.chkBowsActiveInactive);
      this.groupBox18.Controls.Add((Control) this.txtBowsMax);
      this.groupBox18.Controls.Add((Control) this.label54);
      this.groupBox18.Controls.Add((Control) this.txtBowsQuantity);
      this.groupBox18.Controls.Add((Control) this.label56);
      this.groupBox18.Controls.Add((Control) this.txtBowsTimer);
      this.groupBox18.Controls.Add((Control) this.label60);
      this.groupBox18.Controls.Add((Control) this.txtBowsFixed);
      this.groupBox18.Controls.Add((Control) this.optionBowsTimer);
      this.groupBox18.Controls.Add((Control) this.optionBowsFixed);
      ...
      this.tabPage15.Controls.Add((Control) this.groupBox20);
      this.tabPage15.Controls.Add((Control) this.groupBox21);
      ...
      this.groupBox20.Controls.Add((Control) this.lstShieldsFilter);
      this.groupBox20.Controls.Add((Control) this.optionShieldsFilterList);
      this.groupBox20.Controls.Add((Control) this.optionShieldsNoFilter);
      ...
      this.groupBox21.Controls.Add((Control) this.chkShieldsUseHotkey);
      this.groupBox21.Controls.Add((Control) this.txtShieldsHotKey);
      this.groupBox21.Controls.Add((Control) this.chkShieldsDisableWhenDone);
      this.groupBox21.Controls.Add((Control) this.chkShieldsActiveInactive);
      this.groupBox21.Controls.Add((Control) this.txtShieldsMax);
      this.groupBox21.Controls.Add((Control) this.label61);
      this.groupBox21.Controls.Add((Control) this.txtShieldsQuantity);
      this.groupBox21.Controls.Add((Control) this.label62);
      this.groupBox21.Controls.Add((Control) this.txtShieldsTimer);
      this.groupBox21.Controls.Add((Control) this.label63);
      this.groupBox21.Controls.Add((Control) this.txtShieldsFixed);
      this.groupBox21.Controls.Add((Control) this.optionShieldsTimer);
      this.groupBox21.Controls.Add((Control) this.optionShieldsFixed);
      ...
      this.tabPage16.Controls.Add((Control) this.groupBox22);
      this.tabPage16.Controls.Add((Control) this.groupBox23);
      ...
      this.groupBox22.Controls.Add((Control) this.lstArrowsFilter);
      this.groupBox22.Controls.Add((Control) this.optionArrowsFilterList);
      this.groupBox22.Controls.Add((Control) this.optionArrowsNoFilter);
      ...
      this.groupBox23.Controls.Add((Control) this.chkArrowsUseHotkey);
      this.groupBox23.Controls.Add((Control) this.txtArrowsHotKey);
      this.groupBox23.Controls.Add((Control) this.chkArrowsDisableWhenDone);
      this.groupBox23.Controls.Add((Control) this.chkArrowsActiveInactive);
      this.groupBox23.Controls.Add((Control) this.txtArrowsMax);
      this.groupBox23.Controls.Add((Control) this.label64);
      this.groupBox23.Controls.Add((Control) this.txtArrowsQuantity);
      this.groupBox23.Controls.Add((Control) this.label65);
      this.groupBox23.Controls.Add((Control) this.txtArrowsTimer);
      this.groupBox23.Controls.Add((Control) this.label66);
      this.groupBox23.Controls.Add((Control) this.txtArrowsFixed);
      this.groupBox23.Controls.Add((Control) this.optionArrowsTimer);
      this.groupBox23.Controls.Add((Control) this.optionArrowsFixed);
      ...
      this.tabPage17.Controls.Add((Control) this.groupBox16);
      this.tabPage17.Controls.Add((Control) this.groupBox14);
      ...
      this.groupBox16.Controls.Add((Control) this.lblLockStaminaInfo);
      this.groupBox16.Controls.Add((Control) this.chkLockStaminaSet);
      this.groupBox16.Controls.Add((Control) this.txtLockStaminaHotKey);
      this.groupBox16.Controls.Add((Control) this.chkLockStaminaUseHotkey);
      this.groupBox16.Controls.Add((Control) this.lblLockHealthInfo);
      this.groupBox16.Controls.Add((Control) this.chkLockHealthSet);
      this.groupBox16.Controls.Add((Control) this.txtLockHealthHotKey);
      this.groupBox16.Controls.Add((Control) this.chkLockHealthUseHotkey);
      ...
      this.groupBox14.Controls.Add((Control) this.groupBox3);
      this.groupBox14.Controls.Add((Control) this.lblUnbreakableShieldsInfo);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableShieldsSet);
      this.groupBox14.Controls.Add((Control) this.txtUnbreakableShieldsHotKey);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableShieldsUseHotkey);
      this.groupBox14.Controls.Add((Control) this.lblUnbreakableBowsInfo);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableBowsSet);
      this.groupBox14.Controls.Add((Control) this.txtUnbreakableBowsHotKey);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableBowsUseHotkey);
      this.groupBox14.Controls.Add((Control) this.lblUnbreakableWeaponsInfo);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableWeaponsSet);
      this.groupBox14.Controls.Add((Control) this.txtUnbreakableWeaponsHotKey);
      this.groupBox14.Controls.Add((Control) this.chkUnbreakableWeaponsUseHotkey);
      ...
      this.groupBox3.Controls.Add((Control) this.lstUnbreakableFilter);
      this.groupBox3.Controls.Add((Control) this.optionUnbreakableFilterList);
      this.groupBox3.Controls.Add((Control) this.optionUnbreakableNoFilter);
      ...
      this.tabPage21.Controls.Add((Control) this.groupBox6);
      this.tabPage21.Controls.Add((Control) this.groupBox7);
      ...
      this.groupBox6.Controls.Add((Control) this.btnCapturedPositionTP);
      this.groupBox6.Controls.Add((Control) this.label70);
      this.groupBox6.Controls.Add((Control) this.txtCapturedPositionName);
      this.groupBox6.Controls.Add((Control) this.label57);
      this.groupBox6.Controls.Add((Control) this.txtCapturedPositionZ);
      this.groupBox6.Controls.Add((Control) this.label58);
      this.groupBox6.Controls.Add((Control) this.txtCapturedPositionY);
      this.groupBox6.Controls.Add((Control) this.label69);
      this.groupBox6.Controls.Add((Control) this.txtCapturedPositionX);
      this.groupBox6.Controls.Add((Control) this.btnCapturedPositionRemove);
      this.groupBox6.Controls.Add((Control) this.btnCapturedPositionSave);
      this.groupBox6.Controls.Add((Control) this.btnCapturedPositionNew);
      this.groupBox6.Controls.Add((Control) this.lstCapturedPositions);
      ...
      this.groupBox7.Controls.Add((Control) this.btnPositionEdit);
      this.groupBox7.Controls.Add((Control) this.btnPositionRestore);
      this.groupBox7.Controls.Add((Control) this.txtPositionRestoreHotKey);
      this.groupBox7.Controls.Add((Control) this.chkPositionRestoreUseHotkey);
      this.groupBox7.Controls.Add((Control) this.btnPositionSave);
      this.groupBox7.Controls.Add((Control) this.txtPositionSaveHotKey);
      this.groupBox7.Controls.Add((Control) this.chkPositionSaveUseHotkey);
      this.groupBox7.Controls.Add((Control) this.btnPositionJump);
      this.groupBox7.Controls.Add((Control) this.txtPositionJumpHeight);
      this.groupBox7.Controls.Add((Control) this.txtPositionJumpHotKey);
      this.groupBox7.Controls.Add((Control) this.chkPositionJumpUseHotkey);
      this.groupBox7.Controls.Add((Control) this.chkPositionLockHeightSet);
      this.groupBox7.Controls.Add((Control) this.txtPositionLockHeightHotKey);
      this.groupBox7.Controls.Add((Control) this.chkPositionLockHeightUseHotkey);
      this.groupBox7.Controls.Add((Control) this.label68);
      this.groupBox7.Controls.Add((Control) this.txtPositionZ);
      this.groupBox7.Controls.Add((Control) this.label67);
      this.groupBox7.Controls.Add((Control) this.txtPositionY);
      this.groupBox7.Controls.Add((Control) this.label59);
      this.groupBox7.Controls.Add((Control) this.txtPositionX);
      ...
      this.tabPage18.Controls.Add((Control) this.groupBox19);
      ...
      this.groupBox19.Controls.Add((Control) this.lblPowersDarukInfo);
      this.groupBox19.Controls.Add((Control) this.chkPowersDarukSet);
      this.groupBox19.Controls.Add((Control) this.txtPowersDarukHotKey);
      this.groupBox19.Controls.Add((Control) this.chkPowersDarukUseHotkey);
      this.groupBox19.Controls.Add((Control) this.lblPowersUrbosaInfo);
      this.groupBox19.Controls.Add((Control) this.chkPowersUrbosaSet);
      this.groupBox19.Controls.Add((Control) this.txtPowersUrbosaHotKey);
      this.groupBox19.Controls.Add((Control) this.chkPowersUrbosaUseHotkey);
      this.groupBox19.Controls.Add((Control) this.lblPowersRevaliInfo);
      this.groupBox19.Controls.Add((Control) this.chkPowersRevaliSet);
      this.groupBox19.Controls.Add((Control) this.txtPowersRevaliHotKey);
      this.groupBox19.Controls.Add((Control) this.chkPowersRevaliUseHotkey);
      this.groupBox19.Controls.Add((Control) this.lblPowersMiphaInfo);
      this.groupBox19.Controls.Add((Control) this.chkPowersMiphaSet);
      this.groupBox19.Controls.Add((Control) this.txtPowersMiphaHotKey);
      this.groupBox19.Controls.Add((Control) this.chkPowersMiphaUseHotkey);
      ...
      this.tabPage19.Controls.Add((Control) this.groupBox4);
      this.tabPage19.Controls.Add((Control) this.groupBox15);
      ...
      this.groupBox4.Controls.Add((Control) this.btnRunSpeedDefault);
      this.groupBox4.Controls.Add((Control) this.txtRunSpeedDefaultHotKey);
      this.groupBox4.Controls.Add((Control) this.chkRunSpeedDefaultUseHotkey);
      this.groupBox4.Controls.Add((Control) this.btnRunSpeedDown);
      this.groupBox4.Controls.Add((Control) this.txtRunSpeedDownHotKey);
      this.groupBox4.Controls.Add((Control) this.chkRunSpeedDownUseHotkey);
      this.groupBox4.Controls.Add((Control) this.btnRunSpeedUp);
      this.groupBox4.Controls.Add((Control) this.txtRunSpeedUpHotKey);
      this.groupBox4.Controls.Add((Control) this.chkRunSpeedUpUseHotkey);
      this.groupBox4.Controls.Add((Control) this.btnRunSpeedUpdate);
      this.groupBox4.Controls.Add((Control) this.label49);
      this.groupBox4.Controls.Add((Control) this.txtRunSpeed);
      ...
      this.groupBox15.Controls.Add((Control) this.lblUnlimitAmiiboInfo);
      this.groupBox15.Controls.Add((Control) this.chkUnlimitAmiiboSet);
      this.groupBox15.Controls.Add((Control) this.txtUnlimitAmiiboHotKey);
      this.groupBox15.Controls.Add((Control) this.chkUnlimitAmiiboUseHotkey);
      ...
      this.tabPage13.Controls.Add((Control) this.gbActionsFilter);
      this.tabPage13.Controls.Add((Control) this.gbActionsSettings);
      this.tabPage13.Controls.Add((Control) this.groupBox9);
      ...
      this.gbActionsFilter.Controls.Add((Control) this.lstActionsFilter);
      this.gbActionsFilter.Controls.Add((Control) this.optionActionsFilterList);
      this.gbActionsFilter.Controls.Add((Control) this.optionActionsNoFilter);
      ...
      this.gbActionsSettings.Controls.Add((Control) this.chkActionsUseHotkey);
      this.gbActionsSettings.Controls.Add((Control) this.txtActionsHotKey);
      this.gbActionsSettings.Controls.Add((Control) this.chkActionsDisableWhenDone);
      this.gbActionsSettings.Controls.Add((Control) this.cbActionsList);
      this.gbActionsSettings.Controls.Add((Control) this.chkActionsActiveInactive);
      this.gbActionsSettings.Controls.Add((Control) this.txtActionsMax);
      this.gbActionsSettings.Controls.Add((Control) this.label41);
      this.gbActionsSettings.Controls.Add((Control) this.txtActionsQuantity);
      this.gbActionsSettings.Controls.Add((Control) this.label42);
      this.gbActionsSettings.Controls.Add((Control) this.txtActionsTimer);
      this.gbActionsSettings.Controls.Add((Control) this.label43);
      this.gbActionsSettings.Controls.Add((Control) this.txtActionsFixed);
      this.gbActionsSettings.Controls.Add((Control) this.optionActionsTimer);
      this.gbActionsSettings.Controls.Add((Control) this.optionActionsFixed);
      ...
      this.groupBox9.Controls.Add((Control) this.btnActionsRemove);
      this.groupBox9.Controls.Add((Control) this.lstActionsRegistered);
      this.groupBox9.Controls.Add((Control) this.btnActionsNew);
      ...
      this.tabControl2.Controls.Add((Control) this.tabPage22);
      this.tabControl2.Location = new Point(12, 310);
      this.tabControl2.Name = "tabControl2";
      this.tabControl2.SelectedIndex = 0;
      this.tabControl2.Size = new Size(484, 173);
      this.tabControl2.TabIndex = 6;
      this.tabPage10.Controls.Add((Control) this.groupBox5);
      this.tabPage10.Controls.Add((Control) this.groupBox2);
      this.tabPage10.Controls.Add((Control) this.groupBox1);
      this.tabPage10.Controls.Add((Control) this.groupBox12);
      this.tabPage10.Controls.Add((Control) this.groupBox11);
      ...
      this.groupBox5.Controls.Add((Control) this.numSpacingMs);
      this.groupBox5.Controls.Add((Control) this.numInternalLoopMs);
      ...
      NumericUpDown numSpacingMs = this.numSpacingMs;
      int[] bits1 = new int[4];
      bits1[0] = 1000;
      Decimal num1 = new Decimal(bits1);
      numSpacingMs.Maximum = num1;
      ...
      NumericUpDown numInternalLoopMs1 = this.numInternalLoopMs;
      int[] bits2 = new int[4];
      bits2[0] = 1000;
      Decimal num2 = new Decimal(bits2);
      numInternalLoopMs1.Maximum = num2;
      this.numInternalLoopMs.Name = "numInternalLoopMs";
      this.numInternalLoopMs.Size = new Size(65, 20);
      this.numInternalLoopMs.TabIndex = 0;
      NumericUpDown numInternalLoopMs2 = this.numInternalLoopMs;
      int[] bits3 = new int[4];
      bits3[0] = 100;
      Decimal num3 = new Decimal(bits3);
      numInternalLoopMs2.Value = num3;
      this.numInternalLoopMs.ValueChanged += new EventHandler(this.numInternalLoopMs_ValueChanged);
      this.groupBox2.Controls.Add((Control) this.btnGameProcessResume);
      this.groupBox2.Controls.Add((Control) this.btnGameProcessPause);
      ...
      this.groupBox1.Controls.Add((Control) this.btnSettingsImport);
      this.groupBox1.Controls.Add((Control) this.btnSettingsExport);
      this.groupBox1.Controls.Add((Control) this.btnSettingsClear);
      this.groupBox1.Controls.Add((Control) this.btnSettingsSave);
      ...
      this.groupBox12.Controls.Add((Control) this.chkUpdateList);
      this.groupBox12.Controls.Add((Control) this.txtTimerUpdateList);
      this.groupBox12.Controls.Add((Control) this.label45);
      ...
      this.groupBox11.Controls.Add((Control) this.lstEquippedWeapons);
      ...
      this.tabPage22.Controls.Add((Control) this.btnRestoreStaminaBar);
      this.tabPage22.Controls.Add((Control) this.btnNoStaminaBar);
      this.tabPage22.Controls.Add((Control) this.btnCompareAddress);
      this.tabPage22.Controls.Add((Control) this.label74);
      this.tabPage22.Controls.Add((Control) this.txtCompareAddress);
      this.tabPage22.Controls.Add((Control) this.trackTime);
      this.tabPage22.Controls.Add((Control) this.btnMemoryRegions);
      this.tabPage22.Controls.Add((Control) this.btntxtFindMemoryRegionBySize);
      this.tabPage22.Controls.Add((Control) this.label73);
      this.tabPage22.Controls.Add((Control) this.txtFindMemoryRegionBySize);
      this.tabPage22.Controls.Add((Control) this.btnFindMemoryRegionByAddress);
      this.tabPage22.Controls.Add((Control) this.label72);
      this.tabPage22.Controls.Add((Control) this.txtFindMemoryRegionByAddress);
      ...
      this.ClientSize = new Size(1017, 494);
      ...
      this.Controls.Add((Control) this.tabActions);
      this.Controls.Add((Control) this.lblScan);
      this.Controls.Add((Control) this.tabItems);
      this.Controls.Add((Control) this.tabMain);
      this.Controls.Add((Control) this.btnScan);
      ...
      this.numSpacingMs.EndInit();
      this.numInternalLoopMs.EndInit();
